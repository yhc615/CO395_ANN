...
out = get_CIFAR10_data(num_training=50,num_validation=50, num_test=0)
data = {
...
model = FullyConnectedNet(hidden_dims=[100 for i in range(1)], num_classes=10, dropout=0.5, reg=0)
